...
class UI(wx.Frame):
    ...
    def __init__(self, *args, **kwargs):
        wx.Frame.__init__(self, parent=None, title="Colormap Creator", *args, **kwargs)
    ...
    def init_ui(self):
        ...
        self.colors_lb = wx.gizmos.EditableListBox(self.c_panel, wx.ID_ANY, "Colors:", wx.DefaultPosition,
            wx.DefaultSize, style=wx.gizmos.EL_ALLOW_NEW|wx.gizmos.EL_ALLOW_DELETE)
    ...
    def init_menu(self):
        ...
        close_mnui = wx.MenuItem(self.file_mnu, wx.ID_ANY, text="Exit", help="Goodbye!")
