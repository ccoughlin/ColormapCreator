...
class TestUIModel(unittest.TestCase):
    """Tests the UIModel class"""
    good_cmap_file = os.path.join(os.path.dirname(__file__), "good_cmap")
    bad_cmap_file = os.path.join(os.path.dirname(__file__), "bad_cmap")

    def setUp(self):
        self.model = uimodel.UIModel(controller="")
    ...
    def test_get_cmap_dict(self):
        ...
        # Good file
        with open(TestUIModel.good_cmap_file, "r") as fidin:
    ...
    def test_create_cmap(self):
        ...
        self.assertTrue(isinstance(self.model.create_cmap(self.model.get_cmap_dict(TestUIModel.good_cmap_file)),
            colors.Colormap))
        self.assertIsNone(self.model.create_cmap(self.model.get_cmap_dict(TestUIModel.bad_cmap_file)))
