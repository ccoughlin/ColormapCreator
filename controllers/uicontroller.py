...
from models.uimodel import UIModel
import wx
...
class UIController(object):
    ...
    def on_load_cmap(self, evt):
        ...
        file_dlg = wx.FileDialog(parent=self.view, message="Please specify a colormap file", style=wx.FD_OPEN)
